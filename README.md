...
TaskManager - это современное REST API приложение для управления задачами, разработанное на Java с использованием Spring Boot. Проект демонстрирует лучшие практики разработки: чистая архитектура, работа с базой данных, управление миграциями через Liquibase, обработка ошибок, валидация данных и контейнеризация.
